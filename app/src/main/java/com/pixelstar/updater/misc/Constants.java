...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.pixelstar.base.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.build.product";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.pixelstar.buildtype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "pixelstar.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "pixelstar.updater.uri";
